  ...
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={[styles.button, styles.profileActionButton]} onPress={() => navigation.navigate('MyDonations')}>
          <Text style={styles.buttonText}>Yaptığım Bağışlar</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.button, styles.profileActionButton]} onPress={() => navigation.navigate('MyVirtualAdoptions')}>
...
const styles = StyleSheet.create({
  ...
  walletSummaryCard: { width: '100%', backgroundColor: colors.success, borderRadius: 12, padding: 20, marginBottom: 20, elevation: 4, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 3.84, alignItems: 'center' },
  walletSummaryLabel: { fontSize: 16, color: colors.white, marginBottom: 5 },
  walletSummaryBalance: { fontSize: 28, fontWeight: 'bold', color: colors.white, marginBottom: 8 },
  walletSummaryActionText: { fontSize: 14, color: colors.white, opacity: 0.9, textDecorationLine: 'underline' }
});
